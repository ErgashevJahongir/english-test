          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle>O&apos;quv materiallar</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-zinc-500">Har bir mavzu bo&apos;yicha batafsil o&apos;quv materiallari</p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle>Guruhli muhoqamalar</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-zinc-500">Boshqa o&apos;quvchilar bilan tajriba almashish imkoniyati</p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle>Audio materiallar</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-zinc-500">Tinglab tushunish ko&apos;nikmalarini rivojlantirish uchun audio materiallar</p>
              </CardContent>
            </Card>
          </div>
        </div>
