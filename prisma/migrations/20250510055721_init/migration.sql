...
-- CreateEnum
CREATE TYPE "AgeGroup" AS ENUM ('KIDS_7_9', 'KIDS_10_12', 'TEENS_13_15', 'TEENS_16_18');

-- CreateEnum
CREATE TYPE "QuestionType" AS ENUM ('MULTIPLE_CHOICE', 'FILL_IN_BLANK', 'AUDIO_COMPREHENSION', 'IMAGE_BASED');
